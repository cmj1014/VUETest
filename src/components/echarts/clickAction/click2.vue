<template>
  ...
  <div class="flex3">
    ...
    <div style="width:33%"><h4>超时运行任务图</h4></div>
    <div style="width:33%" class="rightBox">
      <div class="flex"><div>资源组使用最多：</div>
      <div>tss_default_pool</div>
        </div>
        
      <div class="flex"><div>开始最多时间段：</div><div>16:00:00到17:00:00点</div></div>
      <div class="flex"><div style="width:130px;">耗时最多任务名：</div><div class="value" style="flex:1;">TW_QA_DY_TB_TN_00_74c7b8235da743d78ee07a4a85762bb9_EPLAT_f450e91a9e4d4d50bbe3ff0f102eaf15</div>
        </div>
    </div>
  </div>
